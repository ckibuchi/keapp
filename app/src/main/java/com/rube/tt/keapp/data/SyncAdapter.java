package com.rube.tt.keapp.data;
    ...
    public static JSONObject Login(ArrayList<NameValuePair> params, String tableName) throws Exception {
       ...
       if(params.size()>0) {
            for (int i = 0; i < params.size(); i++) {
                ...
                if(i==0)
                    url=new URL(url.toString()+"?"+params.get(i).getName()+"="+params.get(i).getValue());
                            else
                    url=new URL(url.toString()+"&"+params.get(i).getName()+"="+params.get(i).getValue());
      ...
      //  String authentication = params.get(0).getValue() + ":" + params.get(1).getValue();
       ...
       // String encoding = Base64.encodeToString(authentication.getBytes(), Base64.NO_WRAP);
        ...
        //{"count":1,"next":null,"previous":null,"results":[{"id":3,"username":"chriskibuchics@gmail.com","first_name":"chris","last_name":"","email":"chriskibuchics@gmail.com","password":"pbkdf2_sha256$20000$F5OamqbC5roW$+H5IgxLnRrhDQkmnLH/FqyF8ub479/V0TFU4CxC79Sg=","is_active":false,"msisdn":"7830202669"}]}
