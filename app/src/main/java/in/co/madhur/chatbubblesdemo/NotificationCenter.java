...
public class NotificationCenter {
    ...
    private static volatile in.co.madhur.chatbubblesdemo.NotificationCenter Instance = null;
    public static in.co.madhur.chatbubblesdemo.NotificationCenter getInstance() {
        in.co.madhur.chatbubblesdemo.NotificationCenter localInstance = Instance;
        if (localInstance == null) {
            synchronized (in.co.madhur.chatbubblesdemo.NotificationCenter.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new in.co.madhur.chatbubblesdemo.NotificationCenter();
                }
            }
        }
