...
import in.co.madhur.chatbubblesdemo.adapters.ChatMessageListAdapter;
import in.co.madhur.chatbubblesdemo.models.ChatMessage;
//import in.co.madhur.chatbubblesdemo.xmpp.XMPPManager;

import java.util.ArrayList;

/*import in.co.madhur.chatbubblesdemo.utils.emojicons.EmojiconEditText;
import in.co.madhur.chatbubblesdemo.utils.emojicons.EmojiconGridView;
import in.co.madhur.chatbubblesdemo.utils.emojicons.EmojiconTextView;
import in.co.madhur.chatbubblesdemo.utils.emojicons.EmojiconsPopup;
import in.co.madhur.chatbubblesdemo.utils.emojicons.emoji.Emojicon;*/
...
public class ChatView extends ActionBarActivity {
    ...
    // LogCat tag
    private static final String TAG = in.co.madhur.chatbubblesdemo.ChatView.class.getSimpleName();
...
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(in.co.madhur.chatbubblesdemo.R.layout.main_chat_layout);
       // setContentView(R.layout.activity_main);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        toolbar = (Toolbar)findViewById(in.co.madhur.chatbubblesdemo.R.id.new_chat_toolbar_layout);
        ...
        listViewMessages = (ListView) findViewById(in.co.madhur.chatbubblesdemo.R.id.list_view_messages);
        ...
        name = i.getStringExtra("name");
            try
                {
                    TextView username=(TextView)findViewById(in.co.madhur.chatbubblesdemo.R.id.user_names);
       ...
       // mEditEmojicon = (EmojiconEditText) findViewById(R.id.editEmojicon);
        ...
        emojiconsIcon = (ImageView)findViewById(in.co.madhur.chatbubblesdemo.R.id.emojicons_pop_icon);
        //emojiIconsCover = (LinearLayout) findViewById(R.id.footer_for_emojiicons);
        parentLayout = (LinearLayout) findViewById(in.co.madhur.chatbubblesdemo.R.id.main_chat_layout_holder);
