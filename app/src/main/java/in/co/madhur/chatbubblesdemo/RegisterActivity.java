...
import in.co.madhur.chatbubblesdemo.utils.CustomAccountAunthenticationActivity;
...
public class RegisterActivity extends CustomAccountAunthenticationActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (sharedPreferences.contains("accountName") ){
			...
			init_service();
			final Intent mainActivity = new Intent(in.co.madhur.chatbubblesdemo.RegisterActivity.this, KEApp.class);
		...
		findViewById(R.id.already_member).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(in.co.madhur.chatbubblesdemo.RegisterActivity.this, Login.class);
				startActivity(i);
				finish();
			}
		});
	...
	private void createAccount() {
		...
		new AsyncTask<String, Void, Intent>() {
			...
			protected Intent doInBackground(String... params) {
				...
				try {
					...
					if (authtoken != null){
						...
						result = new Intent(in.co.madhur.chatbubblesdemo.RegisterActivity.this, FinishSignup.class);
					}else{
						result = new Intent();
			...
			protected void onPreExecute() {
				...
				progressDialog = new ProgressDialog(in.co.madhur.chatbubblesdemo.RegisterActivity.this);
			...
			protected void onPostExecute(Intent intent) {
				...
				try {
					if (intent.hasExtra(KEY_ERROR_MESSAGE)) {
						...
						in.co.madhur.chatbubblesdemo.RegisterActivity.this.startActivity(intent);
						finish();
					}
				}
				catch(Exception e)
	...
	{
		if(BootUpReceiver.getRunning()==0) {
			try {
				/***** For start Service  ***/
			/*	Intent myIntent = new Intent(getApplicationContext(), OfflineMessagesSender.class);
				context.startService(myIntent);*/
				new Intent(getBaseContext(), OfflineMessagesSender.class);
				BootUpReceiver.setRunning(1);
